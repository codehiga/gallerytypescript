...
type Props = {
  item : Photo;
  handleDeleteImage : (item: Photo) => {};
}

export const PhotoItem = ({item, handleDeleteImage} : Props) => {
  const { name, url } = item;
  ...
  return(
    <C.Container>
      ...
      <span>
        ...
        <svg onDoubleClick={() => {handleDeleteImage(item)}} xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-trash3-fill deleteSVG" viewBox="0 0 16 16">
